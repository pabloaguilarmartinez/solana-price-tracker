...
function App() {
  return (
    <>
      <header className="bg-gradient-to-r from-teal-500 to-purple-500 p-4">
      ...
      <main className="bg-black text-white min-h-screen flex flex-col justify-center items-center p-4">
        <div className="w-full max-w-md mx-auto">
          <div
            className="bg-gradient-to-r from-purple-400 via-purple-500 via-30% to-gray-950 text-white border-transparent border-r-black rounded">
